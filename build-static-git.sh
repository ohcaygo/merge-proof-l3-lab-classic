...
tar -xf git.tar.xz
cd git-2.50.1
# Namespace Git error() separately from the statically linked libidn2/gnulib symbol.
make -j2 prefix=/opt/merge-proof-git CFLAGS='-O2 -fno-omit-frame-pointer -Derror=git_error' LDFLAGS=-static \
